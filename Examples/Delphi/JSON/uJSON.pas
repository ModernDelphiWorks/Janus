...
begin
  ...
  try
    ...
    FJSON := TJanusJson.ObjectToJsonString(LPerson);
...
begin
  ...
  LPerson := TJanusJson.JSONToObject<TPerson>(FJSON);
  Memo1.Lines.Add(' ');
  Memo1.Lines.Add('RECRIADO O OBJECT ATRAV�S DO JSON ACIMA, MUDADOS ALGUMAS INFORMA��ES A GERADO NOVO JSON PARA TESTAR.');
  ...
  try
    ...
    FJSON := TJanusJson.ObjectToJsonString(LPerson);
    LJsonToPerson := TJanusJson.JSONToObject<TPerson>(FJSON);

    Memo1.Lines.Add(FJSON);
    Memo1.Lines.Add('');
    Memo1.Lines.Add(TJanusJson.ObjectToJsonString(LJsonToPerson));
  finally
    LPerson.Free;
    LJsonToPerson.Free;
  end;
...
begin
  ...
  LObject := TJanusJSON.JSONStringToJSONObject(FJSON);
  try
    Memo1.Lines.Add(' ');
...
begin
  ...
  LArray := TJanusJSON.JSONStringToJSONArray('[' + FJSON + ']');
  try
    Memo1.Lines.Add(' ');
