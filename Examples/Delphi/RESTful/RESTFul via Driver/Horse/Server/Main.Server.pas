...
begin
  // Controller Geral para o Janus RESTful Component
  FControllerServer := TControllerServer.Create;

  // Forma de criar novos micro servi�os, al�m aos que o Janus Component
  // j� oferece embutido a ele, que � o CRUD completo de todas tabelas, das
