...
begin
  ...
  /// <summary>
  ///   Carregamento Lazy do Janus, favor olhar a classe modelo TProcedimento
  ///   para entender como declarar o tipo como Lazy<T>
  /// <param name="AOwner">
  ///   Objeto pai para que o Janus consiga recuperar o mapeamento dele
  /// </param>
  /// <param name="AObject">
  ///   Objeto que ser� inst�nciado e populado com os dados, pelo mapeamento
  /// </param>
  /// </summary>
