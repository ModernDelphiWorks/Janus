...
type
  ...
  public
    ...
    [Dictionary('nome_fantasia', 'Mensagem de valida��o', '', '', '', taLeftJustify)]
    property nome_fantasia: Nullable<String> read Fnome_fantasia write Fnome_fantasia;

    [Column('razao_social', ftString, 100)]
    [Dictionary('razao_social', 'Mensagem de valida��o', '', '', '', taLeftJustify)]
    ...
    [Dictionary('inscricao_estadual', 'Mensagem de valida��o', '', '', '', taLeftJustify)]
    ...
    [Dictionary('inscricao_municipal', 'Mensagem de valida��o', '', '', '', taLeftJustify)]
    ...
    [Dictionary('home_page', 'Mensagem de valida��o', '', '', '', taLeftJustify)]
    ...
    [Dictionary('usuario_id', 'Mensagem de valida��o', '', '', '', taCenter)]
    ...
    [Dictionary('cidade_id', 'Mensagem de valida��o', '', '', '', taLeftJustify)]
