...
uses
  ...
  Janus.Container.RestFDMemTable,
  Janus.Session.BaseURL,
...
begin
  /// <summary>
  /// Definir URL base na classe sington que ser� usada pelo Janus internamente a sess�o.
  /// </summary>
  TSessionRESTBaseURL.GetInstance.BaseURL := 'http://127.0.0.1:211/datasnap/rest/tjanus';
  // Master
...
//  oDataSnapMaster.OpenWhere('master_id = 74');
  ...
  try
    Memo1.Lines.Text := TJanusJSON.ObjectListToJsonString<Tmaster>(LMasterList);
  finally
    LMasterList.Free;
  end;
end;
