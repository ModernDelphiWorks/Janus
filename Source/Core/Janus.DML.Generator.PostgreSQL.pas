...
unit Janus.DML.Generator.PostgreSQL;
...
function TDMLGeneratorPostgreSQL.GetGeneratorSelect(const ASQL: String;
...
///  PRETENDE CHAR(n) para dnPostgreSQL. Entao a comparacao aqui e' texto contra
...
initialization
  TDriverRegister.RegisterDriver(dnPostgreSQL,
    function: IDMLGeneratorCommand
    begin
      Result := TDMLGeneratorPostgreSQL.Create;
    end);
