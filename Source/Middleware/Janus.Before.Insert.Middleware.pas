...
unit Janus.Before.Insert.Middleware;
...
class function TBeforeInsertMiddleware.GetContextEvents(
...
initialization
  TJanusMiddlewares.RegisterEventCallback('BeforeInsert', TBeforeInsertMiddleware.GetEvent);
  TJanusMiddlewares.RegisterContextEventCallback('BeforeInsert', TBeforeInsertMiddleware.GetContextEvents);
