...
unit Janus.Before.Update.Middleware;
...
class function TBeforeUpdateMiddleware.GetContextEvents(
...
initialization
  TJanusMiddlewares.RegisterEventCallback('BeforeUpdate', TBeforeUpdateMiddleware.GetEvent);
  TJanusMiddlewares.RegisterContextEventCallback('BeforeUpdate', TBeforeUpdateMiddleware.GetContextEvents);
