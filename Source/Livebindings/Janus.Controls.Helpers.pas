...
type
  /// <summary>
  ///   Lista registradora de cada componente do form, para que o Janus
  ///   encontre de forma simples e r�pida, para notificar ao LiveBindings
  /// </summary>
  ...
  ///   Janus encontre de forma simples e r�pida, para notificar ao LiveBindings
  /// </summary>
  TListFieldNames = TDictionary<String, String>;


  /// <summary>
  ///   Classe usada pelo Janus para registrar e notificar o livebindings
  /// </summary>
  TListControls = class
  private
  ...
  /// <summary>
  ///   Helper do TControl, dando recurso ao Janus de capturar o nome da
