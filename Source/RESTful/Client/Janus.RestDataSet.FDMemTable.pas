{
      Janus Brasil � um Janus simples e descomplicado para quem utiliza Delphi
...
unit Janus.RestDataSet.FDMemTable;
...
begin
  ...
  GetDataSetEvents;
  // Seta os eventos do Janus no dataset, para que ele sejam disparados
  SetDataSetEvents;
  ///
