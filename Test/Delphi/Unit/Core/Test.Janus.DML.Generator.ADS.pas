...
type
  ...
  // realmente entrega ao FormatDateTime em Janus.DML.Generator.pas:613/617.
...
begin
  // Este e literalmente o valor que Janus.DML.Generator.pas:613 embute, entre
...
begin
  ...
  // _GetPropertyValue -> Janus.DML.Generator.pas:613. Prova que a mascara
...
begin
  // Mesmo caminho, ramo da hora (Janus.DML.Generator.pas:617). A mascara
