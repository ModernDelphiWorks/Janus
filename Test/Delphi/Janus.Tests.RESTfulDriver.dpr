...
uses
  ...
  /// The same instrument sharpened to a PER-ADDRESS ledger - what is needed to
  /// ask whether the object THE CALLER PASSED was destroyed, when more than one
  /// instance of the entity is alive during the call. Issue #362.
  Test.Janus.Model.OwnedProbe in 'Common\Test.Janus.Model.OwnedProbe.pas',
  ...
  /// WHO OWNS the object the caller hands to the REST ObjectSet family. Update
  /// wrapped it in an OWNING TObjectList and Clear destroyed it, so the obvious
  /// caller - Update then Free - was a double free. Insert and Delete are
  /// driven through the same instrument, which is the enumeration issue #362
  /// left open - issue #362
  Test.Janus.Rest.ObjectSetOwnership in 'Unit\RESTful\Test.Janus.Rest.ObjectSetOwnership.pas';
